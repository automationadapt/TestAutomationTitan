...
public class CreateProjectPage extends BaseTest
{
	...
	// public void fn_CreateProject(String ProjectCode, String ProjectName,
	...
	// String actualAlertText= meancheck();
	// System.out.println(actualAlertText+"Second message");
	// Assert.assertEquals(actualAlertText, AlertMessage,
	// "Project Created Successfully Test Passed");
